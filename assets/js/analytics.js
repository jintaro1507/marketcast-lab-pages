...
const ALLOWED_UTM = {
  // x: Task50.1・XプロフィールリンクをすべてstartへUTM分離するため追加。
  // note: Task50.2・note上のMarketcast Lab紹介からの流入。
  utm_source: ['instagram', 'x', 'note'],
  // social: Task50.1・広告(paid_social)と区別する非有料SNS流入。
  // content: Task50.2・note記事本文からの流入（プロフィール固定導線とは区別）。
  utm_medium: ['paid_social', 'social', 'content'],
  // profile: Task50.1・X/Instagramプロフィールのbioリンク経由。
  // article: Task50.2・note記事本文からの流入。
  utm_campaign: ['launch_2026_09', 'profile', 'article'],
  // reels_beginner_01: 既存の Reels → beginner.html。
  // reels_intro_01: 同じ Reels 素材 → start.html（Task50・intent mismatch解消）。
  // intro_01: Task50.2・note上のMarketcast Lab紹介記事（1本目）。
  utm_content: ['reels_beginner_01', 'reels_intro_01', 'intro_01'],
};
